 ...
 * @since 1.0
 */
public class A112AAARRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A112AAARBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A112AAARBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A112AAARBodyForm aplData) {
