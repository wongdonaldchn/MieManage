 ...
 * @since 1.0
 */
public class A113AADRRequestData implements Serializable {
    /** シリアルバージョンUID */
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A113AADRBodyForm aplData;
     ...
     * @return フォーム
     */
    public A113AADRBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A113AADRBodyForm aplData) {
