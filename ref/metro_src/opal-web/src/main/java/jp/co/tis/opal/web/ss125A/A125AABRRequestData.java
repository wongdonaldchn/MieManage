 ...
 * @since 1.0
 */
public class A125AABRRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A125AABRBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A125AABRBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A125AABRBodyForm aplData) {
