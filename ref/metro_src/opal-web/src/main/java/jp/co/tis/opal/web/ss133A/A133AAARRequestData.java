 ...
 * @since 1.0
 */
public class A133AAARRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A133AAARBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A133AAARBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A133AAARBodyForm aplData) {
