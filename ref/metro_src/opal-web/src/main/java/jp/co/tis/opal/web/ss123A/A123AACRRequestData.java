 ...
 * @since 1.0
 */
public class A123AACRRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A123AACRBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A123AACRBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A123AACRBodyForm aplData) {
