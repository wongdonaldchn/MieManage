 ...
 * @since 1.0
 */
public class A123AAARRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A123AAARBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A123AAARBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A123AAARBodyForm aplData) {
