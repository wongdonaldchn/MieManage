 ...
 * @since 1.0
 */
public class A125AACRRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A125AACRBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A125AACRBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A125AACRBodyForm aplData) {
