 ...
 * @since 1.0
 */
public class A123AABRRequestData implements Serializable {
    ...
    @Valid
    @Required(message = "{M000000001}")
    private A123AABRBodyForm aplData;
     ...
     * @return アプリケーションデータ
     */
    public A123AABRBodyForm getAplData() {
        return aplData;
    }
     ...
     */
    @JsonInclude(Include.NON_NULL)
    public void setAplData(A123AABRBodyForm aplData) {
